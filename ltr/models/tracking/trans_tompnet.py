...
import ltr.models.transformer.trans_filter_predictor as fp
import ltr.models.transformer.trans_heads as heads
...
class ToMPnet(nn.Module):
    ...
    def __init__(self, feature_extractor, trans_feature_extractor, head, head_layer, use_trans2seg_encoder, no_trans_feat=False):
        ...
        self.trans_feature_extractor = trans_feature_extractor
        self.head = head
    ...
    def forward(self, train_imgs, test_imgs, train_bb, *args, **kwargs):
        ...
        # Run head module
        test_scores, bbox_preds = self.head(train_feat_head, test_feat_head, train_bb, trans_train_feat, trans_test_feat, *args, **kwargs)
...
def tompnet50(filter_size=4, head_layer='layer3', backbone_pretrained=True, head_feat_blocks=0, head_feat_norm=True,
    ...
    trans2seg = get_segmentation_model()#.to(device)
