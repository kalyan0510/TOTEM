...
class Head(nn.Module):
    ...
    def get_filter_and_features(self, train_feat, test_feat, trans_train_feat, trans_test_feat, train_label, *args, **kwargs):
        # feat:  Input feature maps. Dims (images_in_sequence, sequences, feat_dim, H, W).
        if self.separate_filters_for_cls_and_bbreg:
            cls_weights, bbreg_weights, test_feat_enc = self.filter_predictor(train_feat, test_feat, trans_train_feat, trans_test_feat, train_label, *args, **kwargs)
        else:
            weights, test_feat_enc = self.filter_predictor(train_feat, test_feat, trans_train_feat, trans_test_feat, train_label, *args, **kwargs)
