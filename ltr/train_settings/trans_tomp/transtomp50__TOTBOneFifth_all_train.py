...
def run(settings):
    ...
    totb_train = Totb(vid_ids=[1,2,3])
    totb_val = Totb(vid_ids=[4,5,6,7,8,9])
    ...
    print(f"Loading {totb_train, lasot_train} datasets")
    # Train sampler and loader
    dataset_train = sampler.DiMPSampler([totb_train, lasot_train], [1, 1],
    ...
    dataset_val = sampler.DiMPSampler([totb_val], [1], samples_per_epoch=settings.val_samples_per_epoch,
    ...
    optimizer = optim.AdamW([
        ...
        {'params': actor.net.head.filter_predictor.parameters(), 'lr': 1e-4},
        {'params': actor.net.feature_extractor.layer3.parameters(), 'lr': 2e-5},
        {'params': actor.net.trans_feature_extractor.encoder.parameters(), 'lr': 2e-5}
    ...
    trainer = LTRTrainer(actor, [loader_train, loader_val], optimizer, settings, lr_scheduler,
                         ...
                         load_ignore_fields=['optimizer', 'settings', 'stats', 'lr_scheduler'], train_fusion_only=False)
