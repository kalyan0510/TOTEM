...
def run(settings):
    ...
    dataset_train = sampler.DiMPSampler([lasot_train, totb_train], [1,1],
                                        samples_per_epoch=10000, max_gap=30, num_test_frames=3, num_train_frames=3,
    ...
    dataset_val = sampler.DiMPSampler([totb_val], [1], samples_per_epoch=5000, max_gap=30,
