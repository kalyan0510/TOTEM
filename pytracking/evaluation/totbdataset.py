...
class TOTBDataset(BaseDataset):
    ...
    def _construct_sequence(self, sequence_name):
        ...
        base_path = f'{self.base_path}/{class_name}'
        anno_path = '{}/{}/groundtruth.txt'.format(base_path, sequence_name)

        ground_truth_rect = load_text(str(anno_path), delimiter=',', dtype=np.float64)

        occlusion_label_path = '{}/{}/full_occlusion.txt'.format(base_path, sequence_name)
        ...
        out_of_view_label_path = '{}/{}/out_of_view.txt'.format(base_path, sequence_name)
        ...
        frames_path = '{}/{}/img'.format(base_path, sequence_name)
