...
from ltr.dataset import Lasot, TrackingNet, MSCOCOSeq, Got10k, Totb
...
def run(settings):
    ...
    settings.batch_size = 64*4
    settings.num_workers = 48
    ...
    dataset_train = sampler.ATOMSampler([lasot_train, totb_train], [1,1],
    ...
    dataset_val = sampler.ATOMSampler([totb_val], [1], samples_per_epoch=500*settings.batch_size, max_gap=50,
